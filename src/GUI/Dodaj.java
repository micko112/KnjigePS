...
public class Dodaj extends javax.swing.JDialog {
    ...
    private FormaMain gf = new FormaMain();
    
    public Dodaj(java.awt.Frame parent, boolean modal, Knjiga knjigazaIzmenu) {
        
        super(parent, modal);
        
        initComponents();
        this.gf = (FormaMain) parent;
    ...
    private void initComponents() {
        ...
        jComboBoxZanr.setModel(new DefaultComboBoxModel(model.Zanr.values())
        );
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            .addComponent(jTextFieldGodina, javax.swing.GroupLayout.DEFAULT_SIZE, 162, Short.MAX_VALUE)
                            .addComponent(jTextFieldISBN, javax.swing.GroupLayout.DEFAULT_SIZE, 162, Short.MAX_VALUE)
    ...
    private void jButtonSaveActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonSaveActionPerformed
       ...
       String isbn = jTextFieldISBN.getText();
        ...
        godina = Integer.parseInt(jTextFieldGodina.getText());
            ...
            JOptionPane.showMessageDialog(this, "jedi gobna promasio si format", "Greska", JOptionPane.ERROR_MESSAGE);
        }
       Zanr zanr = (Zanr) jComboBoxZanr.getSelectedItem();
       
    Random rand = new Random();
     int id = 101+rand.nextInt();
    ...
    private void jButtonIzmeniActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonIzmeniActionPerformed
        ...
        Zanr zanr = (Zanr) jComboBoxZanr.getSelectedItem();
        Knjiga knjiga = new Knjiga(naziv, autor, isbn, godina, zanr);
